...
/*InBrd::InBrd(const InBrd &right)
{
      ...
      for (int i=0; i<right.row;i++)
    {
        ...
        {
            c[i][j].setDisp(right.c[i][j].getDisp());
            c[i][j].setSym(right.c[i][j].getSym());
            c[i][j].setFlgd(right.c[i][j].getFlgd());
            c[i][j].setHddn(right.c[i][j].getHddn());
            c[i][j].setMine(right.c[i][j].getMine());
            c[i][j].setVal(right.c[i][j].getVal());
            c[i][j].setncol(right.c[i][j].getnCol());
            c[i][j].setnrow(right.c[i][j].getnRow());
        }
    }
    //  c=right.c;
}*/
